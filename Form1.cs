...
namespace WordPadMin
{
    public partial class Form1 : Form
    {
        ...
        { 
                ...
                System.Diagnostics.Process.Start(@"WordPadMin.exe");
        ...
        public void NewFile(object sender, EventArgs e)
        {
            if (!saved)
            {
                CurrentFile = new FileInfo("Без названия");
            }
            else
            {
                DialogResult result = MessageBox.Show("Вы действительно хотите выйти?", "Без названия", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
                switch (result){
